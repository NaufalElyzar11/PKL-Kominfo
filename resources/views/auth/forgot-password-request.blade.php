...
<head>
    ...
    <title>Lupa Password - Siap Cuti</title>
...
<div class="flex min-h-screen w-full flex-row overflow-hidden">
    ...
    <div class="hidden w-1/2 relative lg:flex flex-col items-center justify-center p-12 text-center text-white">
        <!-- Background Image -->
        <div class="absolute inset-0 z-0 h-full w-full bg-cover bg-center" style="background-image: url('{{ asset('image/diskominfo.jpg') }}');">
        </div>
        <!-- Blue Overlay -->
        ...
        <div class="mx-auto w-full max-w-[480px]">
            ...
            <div class="mb-10">
                ...
                <p class="text-base text-slate-500 dark:text-slate-400">
                    Masukkan NIP atau Nama Lengkap Anda. Kami akan mengirimkan kode OTP ke WhatsApp Anda.
                </p>
            </div>
            ...
            <!-- Form -->
            <form action="{{ route('password.send') }}" class="flex flex-col gap-6" method="POST">
                @csrf
