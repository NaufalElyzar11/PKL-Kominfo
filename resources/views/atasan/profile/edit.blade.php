...
{{-- resources\views\atasan\profile\edit.blade.php --}}
...
<div class="py-8 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex items-center justify-between mb-2">
            <div>
                <a href="{{ route('atasan.profile.show') }}" class="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 transition-colors font-medium mb-2">
