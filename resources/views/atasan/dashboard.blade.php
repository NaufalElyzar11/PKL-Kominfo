...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <p class="text-gray-600 italic">Panel Atasan Langsung - Sistem Informasi Cuti</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white border-l-4 border-yellow-400 shadow-sm rounded-lg p-6">
            ...
            <a href="{{ route('atasan.approval.index') }}" class="mt-4 block text-sm text-yellow-600 hover:underline font-semibold">Lihat Daftar &rarr;</a>
        </div>
